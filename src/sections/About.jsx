...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("karanvirsinghsidhu99@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                <img
                  ...
                  alt="copy"
                />
                <p className="lg:text-xl md:text-xl font-medium text-white text-gray_gradient">
                  karanvirsinghsidhu99@gmail.com
                </p>
              </div>
            </div>
          </div>
